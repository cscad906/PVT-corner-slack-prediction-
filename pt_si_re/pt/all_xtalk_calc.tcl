...
if {![info exists XTALK_ROOT]} {
    ...
    puts "                 \$PY 4_all_corners.py --root <round2> --phase 1"
...
foreach d [lsort [glob -nocomplain -directory $XTALK_ROOT -type d *]] {
    if {[file exists "$d/xtalk/unique_contexts.tsv"]} { lappend XT_LIST $d }
}
...
if {$XT_BAD > 0} {
    ...
    puts "  전부 정상. 다음은 셸에서:"
    puts "      \$PY 4_all_corners.py --root $XTALK_ROOT --phase 2"
}
puts "===================================================================="
