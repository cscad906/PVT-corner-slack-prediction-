...
if {![info exists XTALK_ROOT]} {
    ...
    puts "                 \$PY 4_all_corners.py --root <round2> --phase 2"
...
if {[llength $XT_LIST] == 0} {
    puts "=================================================================="
    puts "  문제 발생"
    puts "    무엇이   : 5b 를 돌린 코너가 하나도 없습니다."
    puts "               찾아본 곳: $XTALK_ROOT/*/xtalk/victim_load_pins.txt"
    puts "    하실 일  : 셸에서 먼저 돌리세요."
    puts "                 \$PY 4_all_corners.py --root $XTALK_ROOT --phase 1"
    puts ""
    puts "    에러 코드: E-NO5B"
    puts "=================================================================="
    return
...
puts "코너 [llength $XT_LIST]개를 돕니다."
puts ""
...
if {$XT_BAD > 0} {
    ...
    puts "  전부 정상. 다음은 셸에서:"
    puts "      \$PY 4_all_corners.py --root $XTALK_ROOT --phase 3"
}
puts "===================================================================="
