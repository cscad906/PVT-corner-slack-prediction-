...
if {![file exists $VPIN] || ![file exists $ANET]} {
    puts "=================================================================="
    puts "  문제 발생"
    puts "    무엇이   : 물어볼 목록이 없습니다."
    puts "               찾아본 곳: $VPIN"
    puts "                          $ANET"
    puts "    하실 일  : 셸에서 5b_pairs.py 를 먼저 돌리세요."
    puts "                 python3 5b_pairs.py --dir <코너폴더>"
    puts ""
    puts "    에러 코드: E-NOWINLIST"
    puts "=================================================================="
    return
}
...
if {$nv == 0 && $na == 0} {
    puts "=================================================================="
    puts "  문제 발생"
    puts "    무엇이   : 물어볼 대상이 0개였습니다."
    puts "    하실 일  : 5b_pairs.py 화면에서 '물어볼 ...' 숫자를 확인하세요."
    puts ""
    puts "    에러 코드: E-NOWIN"
    puts "=================================================================="
    return
...
puts "끝났습니다. 다음은 셸에서:"
puts "    python3 5c_report.py --dir <코너폴더>"
